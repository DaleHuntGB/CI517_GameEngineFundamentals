...
// DH: My Colour Additions
static const SDL_Color SDL_COLOR_DARKGREY = { 0x1A, 0x1A, 0x1A };
static const SDL_Color SDL_COLOR_SLATEBLUE = { 0x80, 0x80, 0xFF };
static const SDL_Color SDL_COLOR_LIGHTGREY = { 0x3A, 0x3A, 0x3A };
...
class GraphicsEngine {
	...
	public:	
		...
		void UseGUIFont(TTF_Font* GUIFont);
		...
		*/
		...
		void DrawGUIText(const std::string& text, const int& x, const int& y, const int textFontSize);
